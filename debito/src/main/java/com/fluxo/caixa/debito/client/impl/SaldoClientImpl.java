...
public class SaldoClientImpl implements SaldoClient {
    ...
    @Override
    public SaldoPorDataResponse getSaldoDoDia() {
        ...
        ResponseEntity<SaldoPorDataResponse> response =
                restTemplate.exchange(urlServicoSaldo, HttpMethod.GET, entity, SaldoPorDataResponse.class);
